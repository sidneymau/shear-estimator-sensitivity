...
def generate_df(results):
    """
    Takes in the results array generated by the metacalibration() function and returns a pandas dataframe with columns
    for each parameter

    Parameters:

        results:        list of tuples      The tuple list generated by data_generation.py

    Returns:

        results_df:     pandas dataframe    The data transformed into a dataframe, with 4 columns, one for each element of the shear response matrix
    """
