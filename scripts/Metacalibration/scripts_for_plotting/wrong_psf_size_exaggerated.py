...
def generate():
    ...
    gal_psf_ratios = [2.0]
    # offsets unchanged
    wrong_psf_fwhms = np.arange(0.5, 1.3, 0.1)
    # wrong_psf_fwhms = [0.7]
    ...
    comboObj.generate_combinations('all_gaussian_wrong_psfs_trueFWHM=0.7', 4)


def plot():
    # DESCRIPTION OF WHAT'S BEING PLOTTED
    obj = mcObjects.mcSummaryObject('pickles/all_gaussian_wrong_psfs_trueFWHM=0.7.pickle')
